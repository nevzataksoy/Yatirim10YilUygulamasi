...
Kaynak miktarı ve pariteyi gir; hedef miktar otomatik hesaplansın. Borsa kaydındaki net miktarı
gerektiğinde elle düzeltebilirsin.
</div>
</div>
...
<AppPopupSelect v-model="form.source_asset" :options="sourceOptions" label="Dönüştürülen Varlık" />
</div>
<div class="col-12 col-sm-6">
<AppPopupSelect v-model="form.target_asset" :options="targetOptions" label="Hedef Varlık" />
</div>
<div class="col-12">
...
{{ formatQuantity(calculatedGrossTarget, form.target_asset) }} {{ form.target_asset }}
</div>
</div>
<div class="col-6 col-md-3">
...
<q-item-section side>
1 {{ form.source_asset }} = {{ formatNumber(form.pair_rate, 8) }} {{ form.target_asset }}
</q-item-section>
</q-item>
<q-item>
